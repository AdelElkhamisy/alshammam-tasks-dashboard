    ...
    <Row>
      ...
      <div className="side-menu">
        ...
        >
          ...
          />
          <span className="logoTxt">Alshammam Tasks</span>
        </Row>
        <Popover
          menu={projectsData}
          placement="bottom"
        ...
        <div className="menu">
          <div
            className={cx("menu-item", { active: pIndex === 1 })}
            onClick={() => navigate("")}
          >
            <Icon name="home2" /> <span>Home</span>
          </div>
          <div
            className={cx("menu-item", { active: pIndex === 2 })}
            onClick={() => navigate("board")}
          >
            <Icon name="layout" /> <span>Board</span>
          </div>
          <div
            className={cx("menu-item", { active: pIndex === 3 })}
            onClick={() => navigate("messages")}
          >
            <Icon name="message" /> <span>Messages</span>
          </div>
          <div
            className={cx("menu-item", { active: pIndex === 4 })}
            onClick={() => navigate("calendar")}
          >
            <Icon name="calendar" /> <span>Calendar</span>
          </div>
          <div
            className={cx("menu-item", { active: pIndex === 5 })}
