...
export function getProjectLogo(path) {
  ...
  else return require("../images/logo.png");
}
...
export function openFile(src, type) {
  ...
  else window.open(constants.AWS_URL + src, "_blank");
}
...
export function sortConversations(a, b) {
  return (
    new Date(b.message?.createdAt || b.createdAt) -
    new Date(a.message?.createdAt || a.createdAt)
  );
}
